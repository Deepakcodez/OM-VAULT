...
import SaleClientSearcher from './SaleClientSearcher';
...
const SaleForm: React.FC = () => {
  ...
  const submitHandler = async () => {
    try {
      ...
      const validatedData = SaleSchema.parse(purchaseWithId);
          ...
          <div className="flex flex-col gap-2">
            ...
            <div ref={SuggestionContainerRef} >
              <Input
                ...
                />
                  {(isShowSuggestion && supplier.length >0) &&
                       <SaleClientSearcher data={supplier} setSaleData={setSaleData}   setErrors={setErrors} /> }
             </div>
              <Input
                name="gst"
                value={saleData.gst}
